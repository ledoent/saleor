...
def test_google_auth_url_includes_access_type_offline(openid_plugin, settings, rf):
    """When Google is the provider and refresh tokens are enabled, the authorization
    URL should include `access_type=offline` instead of the `offline_access` scope."""
